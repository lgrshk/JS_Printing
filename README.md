...
|----------|-----|--------------|------|
| `ip` | string | Так | IP-адреса принтера (наприклад: '192.168.1.100') |
| `port` | number | Так | Порт принтера (зазвичай 9100, діапазон: 1-65535) |
| `zpl` | string | Так | ZPL команди для друку |
| `serverUrl` | string | Так | URL проміжного сервера (обов'язково HTTPS, наприклад: 'https://print-server.example.com/api/print') |
